...
function Header() {
  ...
  return (
    ...
    >
      <div className="flex item-center w-full md:w-3/4 px-4 md:px-10 pt-10 gap-4 text-stone-800 font-semibold text-5xl md:text-6xl tracking-tight md:break-normal break-words flex-wrap">
