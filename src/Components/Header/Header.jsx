...
function Header() {
  ...
  return (
    ...
    >
      <div className="flex item-center w-full md:w-3/4 px-6 md:px-10 pt-10 gap-4 text-stone-800 font-semibold text-5xl md:text-6xl tracking-tight md:break-normal break-words flex-wrap">
      ...
      <motion.p
        className="px-10 w-full md:w-3/4 text-lg tracking-tight text-stone-800 "
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
